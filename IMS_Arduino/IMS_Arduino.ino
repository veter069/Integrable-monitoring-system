...
//#include "/home/veter/CloudMail/Projects/Arduino/Integrable-monitoring-system/IMS_Arduino/agents/ZabbixAgent.h"
...
void loop() {
	//if((millis() - PrevRefreshTime)>0/*THE CONDITION TO REFRESH HERE*/){
